...
public class LogOutput {
    ...
    public void setSigusr1ToSend(String sigusr1ToSend) {
        AlogMarker.tAB("LogOutput.setSigusr1ToSend", "0");
        if (null == sigusr1ToSend) {
            this.sigusr1ToSend = "false";
        } else {
            this.sigusr1ToSend = sigusr1ToSend;
        }
        AlogMarker.tAE("LogOutput.setSigusr1ToSend", "0");
    }
    ...
    public String getSigusr1ToSend() {
        AlogMarker.tAB("LogOutput.getSigusr1ToSend", "0");
        AlogMarker.tAE("LogOutput.getSigusr1ToSend", "0");
