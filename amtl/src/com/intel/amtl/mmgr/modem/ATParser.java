...
public class ATParser implements CommandParser {

    private final String TAG = "AMTL";
    private final String MODULE = "ATParser";

    public String parseXsioResponse(String xsio) {
        AlogMarker.tAB("ATParser.parseXsioResponse", "0");
        int indexXsio = xsio.indexOf("+XSIO: ");
        AlogMarker.tAE("ATParser.parseXsioResponse", "0");
        return xsio.substring(indexXsio + 7, indexXsio + 8);
    }

    public String parseMasterResponse(String xsystrace, String master) {
        AlogMarker.tAB("ATParser.parseMasterResponse", "0");
        int indexOfMaster;
